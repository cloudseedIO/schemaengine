//curl -XPUT 'http://ec2-35-154-127-238.ap-south-1.compute.amazonaws.com:9200/wk_prod/' -d '

curl -XPUT 'http://13.127.67.38:9200/wk_prod/' -d '
{
  "settings":{
     "index":{
        "analysis":{
...
curl -XPUT 'http://13.127.67.38:9200/wk_prod_summary_index/' -d '
{
  "settings":{
     "index":{
    	 "mapping": {
