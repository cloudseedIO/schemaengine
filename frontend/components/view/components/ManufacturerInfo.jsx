    ...
    return (<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding"  ref={(e)=>{this.container=e}}>
              <div className="col-lg-8 col-md-8 col-sm-6 col-xs-12  " style={{"background":"#FFFFFF"}}>
								...
								<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding text-center margin-bottom-gap-sm">
									...
									<div><h5>{this.props.architect?"schemaengine allows Architects, Interior Designers, and Property Builders to directly interact with 3000+ top brands across the globe":"We are proud to host more than 200,000 products from more than 3,000 brands and manufacturers across the globe"}</h5></div>
								</div>
              </div>
