	...
	try {
		...
		case "userSignUp":
			...
			if(request && request.body && request.body.email){
				...
				var message="Thank you for signing up for cloudseed!";
				...
				if(result.length>0 && result[0].records && Object.keys(result[0].records).length>0){
					...
					if(userDoc.hasOwnProperty("activation") && userDoc.activation){
								...
								html: "<!DOCTYPE html>" +
										"<html lang='en' style='-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;font-family: sans-serif;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;font-size: 10px;-webkit-tap-highlight-color: rgba(0,0,0,0);'>" +
											...
											"<body style='-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin: 0;font-family: Montserrat;font-size: 14px;line-height: 1.42857143;color: #333;background-color: #fff;padding: 0px;'>" +
												...
												"<div style='text-align: center;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin-bottom: 100px;'><span style='font-family: Montserrat;font-size: 13px;color: #4992E3;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;'>https://www.cloudseed.com/resetpassword?code="+(resetPasswordCode)+"</span></div>" +
												"<div style='text-align: center;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin-bottom: 10px;'><span style='font-family: Montserrat;font-size: 13px;color: black;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;'>Copyright @"+(new Date().getFullYear())+", cloudseed Media Works LLP, All rights reserved.</span></div>" +
											"</body>" +
										"</html>",
						...
						CouchBaseUtil.upsertDocumentInContentBucket(userDoc.recordId,userDoc,function(result) {
							...
							var mailData={ 
								to: userDoc.email,
								html: getActivationMailBody(userDoc.email,userDoc.email,"Thank you for signing up for cloudseed!",activationCode),
								subject: "Welcome to cloudseed",
								from: "cloudseed <no-reply@cloudseed.com>",
								inline : [process.cwd()+"/views/branding/wklogonopad.jpg"]
								};
	...
	"<body style='-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin: 0;font-family: &quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif;font-size: 14px;line-height: 1.42857143;color: #333;background-color: #fff;padding: 0px;'>" +
		"<div style='margin: 0 auto;text-align: center;border: 1px solid lightgrey;padding: 2% 10%;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;'>" +
			...
			"<div style='text-align: left;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;'>" +
				"<span style='font-family: Montserrat;font-size: 13px;color: black;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;'><div>Hello "+(emailId)+",</div><div>Thank you for signing up for cloudseed! In order to activate your account please click the button below to verify your email address.</div></span></div><div style='-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin: 30px 30px 50px 30px'><a href='https://www.cloudseed.com/activate?code="+(activationCode)+"' style='-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;box-sizing:border-box;box-sizing:border-box;box-sizing:border-box;text-decoration:none;color:white;background-color:black;padding:5px 40px;font-family: Montserrat;margin:10px;'>ACTIVATE</a></div><div style='text-align: left;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin-bottom: 10px;'><span style='font-family: Montserrat;font-size: 12px;color: black;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;'>If the button above does not work, paste this into your browser:</span></div><div style='text-align: left;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin-bottom: 100px;'><span style='font-family: Montserrat;font-size: 13px;color: #4992E3;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;'>https://www.cloudseed.com/activate?code="+(activationCode)+"</span></div><div style='text-align: left;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin-bottom: 10px;'><span style='font-family: Montserrat;font-size: 13px;color: black;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;'>Copyright @"+(new Date().getFullYear())+", cloudseed Media Works LLP, All rights reserved.</span></div></body></html>",
*/}
...
"<div style='text-align: center;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin-bottom: 30px;'><span style='font-size: 14px;font-family: Montserrat;font-weight: 800;color: #3690fb;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;'>You are almost done, just one more thing..</span></div>" +
		...
		"<span style='font-family: Montserrat;font-size: 13px;color: black;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;'>" +
			...
			((message)?(
				...
				"<div>In order to activate your account please click the below button to verify your email address.</div>"
					...
					"<div>Thank you for signing up with cloudseed! In order to activate your </div>"+
	...
	"</div>" +
		"<div style='-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin: 50px 30px 50px 30px'>" +
			"<a href='https://www.cloudseed.com/activate?code="+(activationCode)+"' style='-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;box-sizing:border-box;box-sizing:border-box;box-sizing:border-box;text-decoration:none;color:white;background-color:black;padding:5px 40px;font-family: Montserrat;margin:10px;'>ACTIVATE" +
			"</a>" +
		"</div>" +
		"<div style='text-align: center;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin-bottom: 10px;'>" +
		...
		"</div>" +
		"<div style='text-align: center;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin-bottom: 100px;'><span style='font-family: Montserrat;font-size: 13px;color: #4992E3;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;'>https://www.cloudseed.com/activate?code="+(activationCode)+"</span>" +
		"</div>" +
		"<div style='text-align: center;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;margin-bottom: 10px;'><span style='font-family: Montserrat;font-size: 13px;color: black;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;'>Copyright @"+(new Date().getFullYear())+", cloudseed Media Works LLP, All rights reserved.</span></div></body></html>");
}
		...
		"<div style='text-align: center;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;'>" +
			"<span style='font-family: Montserrat;font-size: 13px;color: black;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;'>" +
				"<div>Hello "+(emailId)+",</div>" +
					"<div>Thank you for signing up for cloudseed! In order to activate your </div>"+
