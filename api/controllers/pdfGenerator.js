...
var options = {
	...
	/*"header": {"height": "45mm", "contents": '<div style="text-align: center;"><img src="https://www.cloudseed.com/branding/wklogonopad.svg" style="height: 5%; width: 10%;"></div>'  },*/
	...
	"base": "https://www.cloudseed.com", // Base path that's used to load files (images, css, js) when they aren't referenced using a host
	"type": "pdf"
};
...
function getComponents(recordId,callback){
	...
	GenericServer.setOrgSpecificValuesForAllRelatedRecords(mapSetData,function(rsd){
	CouchBaseUtil.executeN1QL(querystring,{parameters:["SpecListProductComponent",recordId]},function(components){
