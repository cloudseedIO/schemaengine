		...
		cbContentBucket.get(data[index].key[1],function(err, result) {
			...
			if(!err && cityName!=undefined){
				...
				if(viewName=="CatCitySuppliers"){
					//console.log("https://www.cloudseed.com/gv/MfrProCatCitySupplier/CatCitySuppliers/"+result.value.categoryName.replace(/\s/g,"")+"-Suppliers-"+cities[data[index].key[2]]+"?ProductCategory="+data[index].key[1]+"&City="+data[index].key[2]);
					...
					doc={
							...
							"target": {
								...
								"htmlMeta": {
									"title": catName+" | Suppliers | "+cityName+", India | cloudseed.com", //"Bidets | Suppliers | Hyderabad | cloudseed.com"
				...
				//console.log("https://www.cloudseed.com/gv/MfrProCatCitySupplier/MfrCitySuppliers/"+result.value.name.replace(/\s/g,"")+"-Suppliers-"+cities[data[index].key[2]]+"?Manufacturer="+data[index].key[1]+"&City="+data[index].key[2]);
				if(viewName=="MfrCitySuppliers"){
					...
					doc={
							...
							"target": {
								...
								"htmlMeta": {
									"title": mfrName+" | Suppliers | "+cityName+",India | cloudseed.com", //"Delta | Suppliers | Hyderabad | cloudseed.com"
